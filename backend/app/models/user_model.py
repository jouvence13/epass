...
class UserRoleEnum(str, enum.Enum):
    ...
    ADMIN_CROUS = "ADMIN_CROUS" # Rétrocompatibilité DB
...
class DocumentTypeEnum(str, enum.Enum):
    ...
    CONTROLLER_BADGE = "CONTROLLER_BADGE"
    ATTESTATION_UNIVERSITAIRE = "ATTESTATION_UNIVERSITAIRE"
    ATTESTATION_CROUS = "ATTESTATION_CROUS"
